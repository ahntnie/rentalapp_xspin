...
class FilterLocationButton extends StatefulWidget {
  final String nameFilter;
  final Map<String, String> selectedOptions;
  final IconData icon;
  final List<FilterLocations> filterOptions;
  ...
  @override
  State<FilterLocationButton> createState() => _FilterLocationButtonState();
}

class _FilterLocationButtonState extends State<FilterLocationButton> {
                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: ElevatedButton(
                                  onPressed: () {
                                    // Cập nhật các lựa chọn khi người dùng nhấn nút Xác nhận
